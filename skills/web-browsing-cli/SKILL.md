...
npx --yes @only-cli/oc@0.5.3 session ls       list saved sessions (name, url, title)
npx --yes @only-cli/oc@0.5.3 session rm [name] forget a saved session: page and cookies
```
